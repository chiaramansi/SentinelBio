...
* **AOI Definition:** You can download the `.geojson` of your Area of Interest using [geojson.io](https://geojson.io/?map=2.44/28.07216/17.93343#map=9.96/43.8972/11.8477) or extract the geographic coordinates of your bounding box using the [BBox Finder](https://bboxfinder.com/#0.000000,0.000000,0.000000,0.000000) tool to generate the spatial extents needed for the scripts.
